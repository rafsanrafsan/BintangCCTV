            ...
            <div class="login-aside d-flex flex-column flex-row-auto">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                        <img src="{{ asset('assets/media/logos/logo3.png') }}" class="max-h-70px" alt="" />
                    </a>
                    <!--end::Aside header-->
                    <!--begin::Aside Title-->
                    <h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl">Secure Your Assets!
                        </h3>
                    <!--end::Aside Title-->
                </div>
                <!--end::Aside Top-->
                ...
                <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center"
                    style="background-position-y: calc(100% + 5rem); background-image: url({{ asset('assets/media/svg/illustrations/login-visual-5.svg') }})">
                </div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
            ...
            <div class="login-content flex-row-fluid d-flex flex-column p-10">
                ...
                <div class="d-flex flex-row-fluid flex-center">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
                        <form action="{{ route('signin') }}" method="POST" class="form" id="kt_login_singin_form" >
                            <!--begin::Title-->
