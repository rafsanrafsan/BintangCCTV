...
Route::get('/login',[\App\Http\Controllers\AuthController::class,'renderin'])->name('login');
...
Route::get('/item-in/print',[App\Http\Controllers\ItemInController::class,'print'])->name('item-in.print');
...
Route::get('/item-out/print',[\App\Http\Controllers\ItemOutController::class,'print'])->name('item-out.print');
...
Route::get('/supplier/print',[App\Http\Controllers\SupplierController::class,'print'])->name('supplier.print');
...
Route::get('/', [\App\Http\Controllers\AuthController::class,'renderin']);
